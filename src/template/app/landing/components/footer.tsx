...
import { Code2, Code2, Code2, Code2, Heart } from 'lucide-react'
...
const socialLinks = [
  { name: 'Code2', href: '#', icon: Code2 },
  { name: 'GitHub', href: 'https://github.com/silicondeck/shadcn-dashboard-landing-template', icon: Code2 },
  { name: 'LinkedIn', href: '#', icon: Code2 },
  { name: 'YouTube', href: '#', icon: Code2 },
]
