...
import { Menu, Code2, LayoutDashboard, ChevronDown, X, Moon, Sun } from 'lucide-react'
...
import { getAppUrl } from '@/template/lib/utils'
import { Logo } from '@/template/components/logo'
import { MegaMenu } from '@/template/components/landing/mega-menu'
import { ModeToggle } from '@/template/components/mode-toggle'
import { useTheme } from '@/template/hooks/use-theme'
